...
import ua.testprojectsolveast.cachemap.Clock;
 ...
 * and you have a corresponding ua.testprojectsolveast.refactor.Person class with id of type Long, you can create a cache
 * with 60-second expiry like this: <p>
 * <pre>
 * ua.testprojectsolveast.cachemap.base.CacheMap&lt;Long, ua.testprojectsolveast.refactor.Person&gt; cache = new AbstractCacheMap&lt;Long, ua.testprojectsolveast.refactor.Person&gt;();
 ...
 * <p/>
 * <pre>
 * ua.testprojectsolveast.refactor.Person person = cache.get(personId);
 * if (person == null) {
 ...
 * the ua.testprojectsolveast.base.Clock class, not System.currentTimeMillis(). That way unit tests can override the
 * time.
 * </li>
 * </ul>
 *
